...
iop_raid_accel = ["Sub Code", 0x0000FFFF, {
    ...
    0x00000020: ("IOP_LOGINFO_SUBCODE_RACC_PLB_SLAVE_0_ERROR", None, "PLB Slave 0 detected an error"),
    0x00000040: ("IOP_LOGINFO_SUBCODE_RACC_CFG_ACCESS_ERROR", None, "AI slave connected to PLB0 detected an access error"),
    0x00000080: ("IOP_LOGINFO_SUBCODE_RACC_DMA_1_COMP_Q_FULL", None, "DMA 1 completion queue full"),
    0x00000100: ("IOP_LOGINFO_SUBCODE_RACC_DMA_0_COMP_Q_FULL", None, "DMA 0 completion queue full"),
    0x00000200: ("IOP_LOGINFO_SUBCODE_RACC_DMA_1_HALT_ERROR", None, "DMA 1 detected an error and halted"),
    0x00000400: ("IOP_LOGINFO_SUBCODE_RACC_DMA_0_HALT_ERROR", None, "DMA 0 detected an error and haloted"),
}]
...
pl_encl_mgmt_err = ["Sub Code", 0x0000FFFF, {
    ...
    0x00000050: ("PL_LOGINFO_CODE_ENCL_MGMT_ADDR_MODE_NOT_SUPPORTED", None, "Address mode not supported"),
    ...
    0x00000090: ("PL_LOGINFO_CODE_ENCL_MGMT_GPIO_FRAME_ERROR", None, "GPIO not allocate a frame"),
    ...
    0x000000E0: ("PL_LOGINFO_CODE_ENCL_MGMT_SMP_FRAME_ALLOC_ERROR", None, "Cannot get a frame for the SMP command"),
    0x000000F0: ("PL_LOGINFO_CODE_ENCL_MGMT_UNAUTHORIZED_DEVICE", None, "Slot has an unauthorized device"),
    0x000000F1: ("PL_LOGINFO_CODE_ENCL_MGMT_SES_PAGE_A_MAP_ERROR", None, "SEP Request with invalid slot for mapping page 0x0A"),
    0x000000F2: ("PL_LOGINFO_CODE_ENCL_MGMT_VPP_DEV_IO_ERROR", None, "Device ISTWI transfer error"),
    ...
    0x00000102: ("PL_LOGINFO_DA_SEP_ISTWI_INTR_IN_IDLE_STATE", None, "ISTWI interrupt received when idle"),
    ...
    0x00000106: ("PL_LOGINFO_DA_SEP_STOP_ON_DATA", None, "SEP stopped when transferring data"),
    0x00000107: ("PL_LOGINFO_DA_SEP_STOP_ON_SENSE_DATA", None, "SEP stopped when transferring sense data"),
    0x00000108: ("PL_LOGINFO_DA_SEP_UNSUPPORTED_SCSI_STATUS_1", None, "SEP returned an unknown SCSI status"),
    0x00000109: ("PL_LOGINFO_DA_SEP_UNSUPPORTED_SCSI_STATUS_2", None, "SEP returned an unknown SCSI status"),
    0x0000010A: ("PL_LOGINFO_DA_SEP_CHKSUM_ERROR_AFTER_STOP", None, "SEP returned a bad checksum after a stop"),
    0x0000010B: ("PL_LOGINFO_DA_SEP_CHKSUM_ERROR_AFTER_STOP_GETDATA", None, "SEP returned a bad checksum after a stop while getting data"),
    0x0000010C: ("PL_LOGINFO_DA_SEP_UNSUPPORTED_COMMAND", None, "SEP doesn't support CDB opcode"),
    0x0000010D: ("PL_LOGINFO_DA_SEP_UNSUPPORTED_COMMAND_2", None, "SEP doesn't support CDB opcode location 2"),
    0x0000010E: ("PL_LOGINFO_DA_SEP_UNSUPPORTED_COMMAND_3", None, "SEP doesn't support CDB opcode location 3"),
}]
